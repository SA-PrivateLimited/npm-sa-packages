 ...
 */
export function ImageViewer({ images, initialIndex = 0, open, onClose, label = 'Image viewer', closeLabel = 'Close', prevLabel = 'Previous image', nextLabel = 'Next image', className = '', style, testId = 'hs-image-viewer', }) {
    const titleId = useId();
