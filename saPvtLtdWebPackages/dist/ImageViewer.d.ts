 ...
 */
export declare function ImageViewer({ images, initialIndex, open, onClose, label, closeLabel, prevLabel, nextLabel, className, style, testId, brandMarkSrc, brandMarkLabel, }: ImageViewerProps): import("react").ReactPortal | null;
